...
> Teletrasporta allo spawn chi cade nel void dello spawn.
...
**DadaSpawnSafety 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Teletrasporta allo spawn chi cade nel void dello spawn.

| Field | Value |
| --- | --- |
| Plugin | `DadaSpawnSafety` |
| Version | `1.0` |
| Category | Security and Staff Tools |
| Main class | `it.dadasmp.spawnsafety.DadaSpawnSafety` |
...
`release/DadaSpawnSafety-1.0.jar`
